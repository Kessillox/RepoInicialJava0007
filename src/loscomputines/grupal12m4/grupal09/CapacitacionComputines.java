...
import loscomputines.grupal9m4.AsistenteCapacitacion;

import java.util.Scanner;


/**
 * esta clase sirve para obtener los datos de las capasitaciones y trabajar con ellos
 * @version 01-06-2023
 * @author Sergio, Livio, Geneis, Nazly
 * @var asistenteCantidad, posicion, scan, listaAsistentes, empresa, instancia, asistente
 * **/
public class CapacitacionComputines {
    ...
    //Datos Asistente
    private loscomputines.grupal9m4.AsistenteCapacitacion asistente;

    //VARIABLES DE LA CLASE
    //INSTANCIAR = Scanner scan | INICIALIZAR = new Scanner(System.in);
    private Scanner scan = new Scanner(System.in);
    private int asistenteCantidad;
    private loscomputines.grupal9m4.AsistenteCapacitacion[] listaAsistentes;
    ...
    public void datosCapacitacion () {
        ...
        this.listaAsistentes = new loscomputines.grupal9m4.AsistenteCapacitacion[asistenteCantidad];
    }
